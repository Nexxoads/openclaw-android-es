...
class MainActivity : FlutterActivity() {
    private val CHANNEL = "com.openclaw.es/native"
    private val EVENT_CHANNEL = "com.openclaw.es/gateway_logs"
        ...
        MethodChannel(flutterEngine.dartExecutor.binaryMessenger, CHANNEL).setMethodCallHandler { call, result ->
            when (call.method) {
                ...
                "updateNodeNotification" -> {
                    val text = call.argument<String>("text") ?: "Nodo conectado"
                ...
                "showUrlNotification" -> {
                    ...
                    val title = call.argument<String>("title") ?: "URL detectada"
                    if (url != null) {
    ...
    private fun createUrlNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channel = NotificationChannel(
                ...
                description = "Avisos cuando se detecta una URL"
            }
