...
class NativeBridge {
  ...
  static Future<String?> startLocalTunnel({int port = 18789}) async {
    return await _channel.invokeMethod<String>('startLocalTunnel', {'port': port});
  }

  static Future<void> stopLocalTunnel() async {
    await _channel.invokeMethod('stopLocalTunnel');
  }

  static Future<String?> getLocalTunnelUrl() async {
    return await _channel.invokeMethod<String>('getLocalTunnelUrl');
  }

  static Future<bool> isLocalTunnelRunning() async {
