...
class _SetupWizardScreenState extends State<SetupWizardScreen> {
                  ...
                  if (state.isComplete)
                    ...
                    SizedBox(
                      ...
                      child: FilledButton.icon(
                        ...
                        label: Text(_started ? 'Reintentar instalación' : 'Instalar'),
                      ),
                    ),
                  if (!_started) ...[
                    const SizedBox(height: 8),
                    Center(
                      child: Text(
                        'Requiere ~500 MB libres y conexión a internet',
  ...
  Widget _buildSteps(SetupState state, ThemeData theme, bool isDark) {
    final steps = [
      (1, 'Descargar Ubuntu (rootfs)', SetupStep.downloadingRootfs),
      (2, 'Extraer rootfs', SetupStep.extractingRootfs),
      (3, 'Instalar Node.js', SetupStep.installingNode),
      (4, 'Instalar OpenClaw', SetupStep.installingOpenClaw),
      (5, 'Configurar parche Bionic', SetupStep.configuringBypass),
    ];
