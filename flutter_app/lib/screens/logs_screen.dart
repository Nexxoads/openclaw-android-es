      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            ...
            tooltip: _autoScroll ? 'Desplazamiento automático activo' : 'Desplazamiento automático desactivado',
            ...
            child: RepaintBoundary(
              ...
              builder: (context, provider, _) {
                ...
                if (filtered.isEmpty) {
                  return Center(
                    child: Text(
                      logs.isEmpty ? 'Sin registros. Inicia el gateway.' : 'Nada coincide con el filtro.',
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(path != null
            ? 'Captura guardada: ${path.split('/').last}'
