      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            StatusCard(
              title: 'Terminal',
              subtitle: 'Shell Ubuntu con OpenClaw',
              icon: Icons.terminal,
              ...
              builder: (context, provider, _) {
                ...
                final subtitle = provider.state.isRunning
                    ? (token != null
                        ...
                        : 'Abrir panel web de OpenClaw')
                    : 'Inicia el gateway primero';
                return StatusCard(
                  title: 'Panel web',
                  subtitle: subtitle,
            ...
            StatusCard(
              title: 'Integración',
              subtitle: 'Claves API y enlace inicial',
              icon: Icons.vpn_key,
              trailing: const Icon(Icons.chevron_right),
              onTap: () => Navigator.of(context).push(
            ...
            StatusCard(
              title: 'Paquetes',
              subtitle: 'Herramientas opcionales (Go, Homebrew, SSH)',
            ...
            StatusCard(
              title: 'Acceso SSH',
              subtitle: 'Terminal remoto por SSH',
              icon: Icons.terminal,
              trailing: const Icon(Icons.chevron_right),
              onTap: () => Navigator.of(context).push(
            ...
            StatusCard(
              title: 'Registros',
              subtitle: 'Salida y errores del gateway',
            ...
            StatusCard(
              ...
              subtitle: 'Exportar o restaurar la configuración',
              icon: Icons.backup,
              trailing: const Icon(Icons.chevron_right),
              onTap: () => Navigator.of(context).push(
                MaterialPageRoute(builder: (_) => const SettingsScreen()),
                ...
                return StatusCard(
                  ...
                  subtitle: nodeState.isPaired
                      ...
                      : nodeState.isDisabled
                          ? 'Capacidades del dispositivo para la IA'
            ...
            Center(
              child: Column(
                children: [
                  Text(
                    'OpenClaw ES v${AppConstants.version}',
